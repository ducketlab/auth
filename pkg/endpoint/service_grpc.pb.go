...
func (c *endpointServiceClient) DescribeEndpoint(ctx context.Context, in *DescribeEndpointRequest, opts ...grpc.CallOption) (*Endpoint, error) {
	out := new(Endpoint)
	err := c.cc.Invoke(ctx, "/auth.endpoint.EndpointService/DescribeEndpoint", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *endpointServiceClient) QueryEndpoints(ctx context.Context, in *QueryEndpointRequest, opts ...grpc.CallOption) (*Set, error) {
	out := new(Set)
	err := c.cc.Invoke(ctx, "/auth.endpoint.EndpointService/QueryEndpoints", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *endpointServiceClient) Registry(ctx context.Context, in *RegistryRequest, opts ...grpc.CallOption) (*RegistryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auth.endpoint.EndpointService/Registry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *endpointServiceClient) DeleteEndpoint(ctx context.Context, in *DeleteEndpointRequest, opts ...grpc.CallOption) (*Endpoint, error) {
	out := new(Endpoint)
	err := c.cc.Invoke(ctx, "/auth.endpoint.EndpointService/DeleteEndpoint", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EndpointService_DescribeEndpoint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.endpoint.EndpointService/DescribeEndpoint",
	}
...
func _EndpointService_QueryEndpoints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.endpoint.EndpointService/QueryEndpoints",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EndpointService_Registry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.endpoint.EndpointService/Registry",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EndpointService_DeleteEndpoint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.endpoint.EndpointService/DeleteEndpoint",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var EndpointService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "auth.endpoint.EndpointService",
